describe('Покупка аватара', function () {                                // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[type="email"]').type('roman.magnyshev@yandex.ru');                   // вводим логин
         cy.get('input[type="password"]').type('SHys282828');               // вводим пароль
         ...
         cy.get('.k_input_name').type('ROMAN MAG');                           // вводим имя владельца действия карты
